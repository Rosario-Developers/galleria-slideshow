export const paints = [
...

  {
    ...
    description:
      'Guernica is a large 1937 oil painting by Spanish artist Pablo Picasso. It is one of his best-known works, regarded by many art critics as the most moving and powerful anti-war painting in history. Guernica is exhibited in the Museo Reina Sofía in Madrid.',
  },
  {
  ...
  },
  {
    ...
    description:
      'The Sleeping Gypsy is an 1897 oil painting by French Naïve artist Henri Rousseau. It is a fantastical depiction of a lion musing over a sleeping woman on a moonlit night. Rousseau first exhibited the painting at the 13th Salon des Indépendants, and tried unsuccessfully to sell it to the mayor of his hometown, Laval. ',
  },
  {
    ...
    description:
      'The Basket of Apples is a still life oil painting by French artist Paul Cézanne, which he created c. 1893. The painting rejected realistic representation in favour of distorting objects to create multiple perspectives. This approach eventually influenced other art movements, including Fauvism and Cubism.',
  },
  {
    name: 'The Swing',
    year: 1886,
